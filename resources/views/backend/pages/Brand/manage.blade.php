											  ...
											  <div class="modal-dialog" role="document">
											    <div class="modal-content">
											      <div class="modal-header">
											        <h5 class="modal-title" id="exampleModalLabel">Do you want to Delete the '{{ $brand->name }}' Brand?</h5>
											        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
											          <span aria-hidden="true">&times;</span>
											        </button>
											      </div>
											      <div class="modal-body">
											        <p>This '{{ $brand->name }}' brand will be permanently deleted from the database. If you want, you can keep the ‘status’ ’inactive’ without deleting it. So that you can turn on later. Otherwise delete permanently.</p>
											      </div>
